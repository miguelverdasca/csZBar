...
implements SurfaceHolder.Callback {
    ...
    private void setUpCamera() {
        // If request is cancelled, the result arrays are empty.
			...
			//Image
            byte [] imageBinary = Base64.getDecoder().decode(params.optString("imageLogo"));
            Bitmap imageBipmap = BitmapFactory.decodeByteArray(imageBinary, 0, imageBinary.length);
            ...
            // Update view with customisable image
            ImageView image = (ImageView) findViewById(getResourceId("id/csZbarScannerImageLogo"));
			
			// in test
			image.setImageBitmap(imageBipmap);
            ...
            findViewById(getResourceId("id/linearTopLayout")).bringToFront();
